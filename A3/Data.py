...
if __name__ == "__main__":
    ...
    # TODO update probability numbers
    data_class_2 = DataClass()
    f1 = DataFeature(None, 0.3, 0.3)
    data_class_2.add_feature(f1)
    f2 = DataFeature(f1, 0.25, 0.67)
    data_class_2.add_feature(f2)
    f3 = DataFeature(f1, 0.55, 0.23)
    data_class_2.add_feature(f3)
    f4 = DataFeature(f1, 0.93, 0.76)
    data_class_2.add_feature(f4)
    f5 = DataFeature(f2, 0.4, 0.44)
    data_class_2.add_feature(f5)
    f6 = DataFeature(f3, 0.65, 0.32)
    data_class_2.add_feature(f6)
    f7 = DataFeature(f4, 0.11, 0.35)
    data_class_2.add_feature(f7)
    f8 = DataFeature(f4, 0.8, 0.22)
    data_class_2.add_feature(f8)
    f9 = DataFeature(f6, 0.76, 0.78)
    data_class_2.add_feature(f9)
    f0 = DataFeature(f6, 0.56, 0.43)
    data_class_2.add_feature(f0)

    # TODO update probability numbers
    data_class_3 = DataClass()
    f1 = DataFeature(None, 0.3, 0.3)
    data_class_3.add_feature(f1)
    f2 = DataFeature(f1, 0.25, 0.67)
    data_class_3.add_feature(f2)
    f3 = DataFeature(f1, 0.55, 0.23)
    data_class_3.add_feature(f3)
    f4 = DataFeature(f1, 0.93, 0.76)
    data_class_3.add_feature(f4)
    f5 = DataFeature(f2, 0.4, 0.44)
    data_class_3.add_feature(f5)
    f6 = DataFeature(f3, 0.65, 0.32)
    data_class_3.add_feature(f6)
    f7 = DataFeature(f4, 0.11, 0.35)
    data_class_3.add_feature(f7)
    f8 = DataFeature(f4, 0.8, 0.22)
    data_class_3.add_feature(f8)
    f9 = DataFeature(f6, 0.76, 0.78)
    data_class_3.add_feature(f9)
    f0 = DataFeature(f6, 0.56, 0.43)
    data_class_3.add_feature(f0)

    # TODO update probability numbers
    data_class_4 = DataClass()
    f1 = DataFeature(None, 0.3, 0.3)
    data_class_4.add_feature(f1)
    f2 = DataFeature(f1, 0.25, 0.67)
    data_class_4.add_feature(f2)
    f3 = DataFeature(f1, 0.55, 0.23)
    data_class_4.add_feature(f3)
    f4 = DataFeature(f1, 0.93, 0.76)
    data_class_4.add_feature(f4)
    f5 = DataFeature(f2, 0.4, 0.44)
    data_class_4.add_feature(f5)
    f6 = DataFeature(f3, 0.65, 0.32)
    data_class_4.add_feature(f6)
    f7 = DataFeature(f4, 0.11, 0.35)
    data_class_4.add_feature(f7)
    f8 = DataFeature(f4, 0.8, 0.22)
    data_class_4.add_feature(f8)
    f9 = DataFeature(f6, 0.76, 0.78)
    data_class_4.add_feature(f9)
    f0 = DataFeature(f6, 0.56, 0.43)
    data_class_4.add_feature(f0)
